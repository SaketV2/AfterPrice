...
export default async function SubscriptionsPage() {
  ...
  return <><PageIntro title="Subscriptions" description="Track renewal dates, public plan changes and the cost you have actually agreed to pay." action={<Link href="/app/add?type=subscription" className="inline-flex min-h-11 items-center gap-2 rounded-input bg-accent px-4 text-sm font-bold text-white hover:bg-[hsl(var(--accent-hover))]"><CirclePlus className="h-4 w-4" />Add subscription</Link>} /><SubscriptionList records={records} /></>
}
