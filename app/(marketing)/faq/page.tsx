  ...
  return (
    <main>
      ...
      <section className="px-5 pb-24 sm:px-8 sm:pb-32 lg:px-10">
        <div className="mx-auto max-w-3xl"><FaqAccordion items={faqItems} /><div className="mt-14 flex flex-col justify-between gap-6 rounded-2xl bg-[#e7eafe] p-6 sm:flex-row sm:items-center sm:p-8"><div><h2 className="font-[family-name:var(--font-display)] text-2xl font-bold leading-tight tracking-[-0.03em]">See one change with its evidence.</h2><p className="mt-2 text-sm leading-6 text-[#5d6673]">The interactive demo is the fastest way to understand the record.</p></div><ButtonLink href="/demo">Open the demo <ArrowUpRightIcon /></ButtonLink></div></div>
      </section>
    </main>
  )
}
