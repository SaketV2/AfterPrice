...
export default function ResourcesPage() {
  ...
  return (
    <main id="main-content" tabIndex={-1}>
      ...
      <section className="px-5 pb-28 sm:px-8 sm:pb-40 lg:px-10"><div className="mx-auto flex max-w-[1280px] flex-col justify-between gap-7 rounded-xl bg-[hsl(var(--surface-dark))] px-7 py-10 text-[hsl(var(--foreground-on-dark))] sm:flex-row sm:items-center sm:px-10"><div><p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[hsl(var(--signal-lime))]">See it in context</p><h2 className="mt-4  text-3xl font-bold tracking-[-0.035em] sm:text-4xl">The product starts with the record.</h2></div><ButtonLink href="/demo" variant="light">Open the demo <ArrowUpRightIcon /></ButtonLink></div></section>
    </main>
  )
}
