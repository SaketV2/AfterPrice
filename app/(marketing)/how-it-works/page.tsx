  ...
  return (
    <main>
      <section className="px-5 pb-20 pt-16 sm:px-8 sm:pb-28 sm:pt-24 lg:px-10">
        <div className="mx-auto grid max-w-[1280px] gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-center">
          <div>
            ...
            <p className="mt-7 max-w-xl text-lg leading-8 text-[#5d6673]">AfterPrice turns a purchase, plan or renewal into a record you can inspect later. The point is a useful decision, not another notification.</p>
            <div className="mt-9 flex flex-wrap gap-3"><ButtonLink href="/demo">Open the demo <ArrowUpRightIcon /></ButtonLink><ButtonLink href="/pricing" variant="secondary">See pricing</ButtonLink></div>
          </div>
          <ChangeRail />
        </div>
      </section>
      ...
      <section className="px-5 pb-24 pt-20 sm:px-8 sm:pb-32 sm:pt-28 lg:px-10">
        <div className="mx-auto flex max-w-[1280px] flex-col justify-between gap-7 rounded-2xl bg-[#e7eafe] px-6 py-10 sm:flex-row sm:items-center sm:px-10"><div><h2 className="max-w-2xl font-[family-name:var(--font-display)] text-3xl font-bold leading-tight tracking-[-0.03em] sm:text-4xl">Follow one change from baseline to action.</h2></div><ButtonLink href="/demo">Open interactive demo <ArrowUpRightIcon /></ButtonLink></div>
      </section>
    </main>
  )
}
